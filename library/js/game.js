...
var game = new Phaser.Game(window.innerWidth, window.innerHeight, Phaser.AUTO, '', {
    preload: function(){
        game.load.image('base', 'library/assets/images/base.png');
        game.load.image('story', 'library/assets/images/story.png');
        game.load.image('ground', 'library/assets/images/ground.png');
        game.load.image('block', 'library/assets/images/block.png');
        game.load.image('arrow', 'library/assets/images/arrow.png');
    },
    create: function(){
        // Start physics
...
function dropStory(pos) {
    ...
    currentStory.body.data.gravityScale = 25;
